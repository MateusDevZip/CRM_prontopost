...
function icone(string $nome, int $tamanho = 16, string $largura = '2'): string
{
    $paths = [
        ...
        'message-circle' => '<path d="M21 11.5a8.38 8.38 0 01-.9 3.8 8.5 8.5 0 01-7.6 4.7 8.38 8.38 0 01-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 01-.9-3.8 8.5 8.5 0 014.7-7.6 8.38 8.38 0 013.8-.9h.5a8.48 8.48 0 018 8v.5z"></path>',
        'download' => '<path d="M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4"></path><path d="M7 10l5 5 5-5M12 15V3"></path>',
        'grip' => '<circle cx="9" cy="6" r="1.2"></circle><circle cx="9" cy="12" r="1.2"></circle><circle cx="9" cy="18" r="1.2"></circle><circle cx="15" cy="6" r="1.2"></circle><circle cx="15" cy="12" r="1.2"></circle><circle cx="15" cy="18" r="1.2"></circle>',
    ];
    $inner = $paths[$nome] ?? '';
